...
def get_overseas_order(ord_dv="", excg_cd="", itm_no="", qty=0, unpr=0, tr_cont="", FK100="", NK100="", dataframe=None):  # 국내주식주문 > 주식주문(현금)
    ...
    if ord_dv == "buy":
        if excg_cd in ("NASD","NYSE","AMEX"):
            tr_id = "VTTT1002U"  # 미국 매수 주문 [모의투자] VTTT1002U
        elif excg_cd == "SHEK":
            tr_id = "VTTS1002U"  # 홍콩 매수 주문 [모의투자] VTTS1002U
        elif excg_cd == "SHAA":
            tr_id = "VTTS0202U"  # 중국상해 매수 주문 [모의투자] VTTS0202U
        elif excg_cd == "SZAA":
            tr_id = "VTTS0305U"  # 중국심천 매수 주문 [투자] VTTS0305U
        elif excg_cd == "TKSE":
            tr_id = "VTTS0308U"  # 일본 매수 주문 [모의투자] VTTS0308U
        elif excg_cd in ("HASE", "VNSE"):
            tr_id = "VTTS0311U"  # 베트남(하노이,호치민) 매수 주문 [모의투자] VTTS0311U
        else:
            print("해외거래소코드 확인요망!!!")
            return None
    elif ord_dv == "sell":
        if excg_cd in ("NASD", "NYSE", "AMEX"):
            tr_id = "VTTT1006U"  # 미국 매도 주문 [모의투자] VTTT1006U
        elif excg_cd == "SHEK":
            tr_id = "VTTS1001U"  # 홍콩 매도 주문 [모의투자] VTTS1001U
        elif excg_cd == "SHAA":
            tr_id = "VTTS1005U"  # 중국상해 매도 주문 [모의투자] VTTS1005U
        elif excg_cd == "SZAA":
            tr_id = "VTTS0304U"  # 중국심천 매도 주문 [모의투자] VTTS0304U
        elif excg_cd == "TKSE":
            tr_id = "VTTS0307U"  # 일본 매도 주문 [모의투자] VTTS0307U
        elif excg_cd in ("HASE", "VNSE"):
            tr_id = "VTTS0311U"  # 베트남(하노이,호치민) 매도 주문 [모의투자] VTTS0311U
        else:
            print("해외거래소코드 확인요망!!!")
            return None
    else:
...
def get_overseas_order_rvsecncl(excg_cd="", itm_no="", orgn_odno="", rvse_cncl_dvsn_cd="", qty=0, unpr=0, tr_cont="", dataframe=None):
    ...
    if excg_cd in ("NASD", "NYSE", "AMEX"):
        tr_id = "VTTT1004U"  # 미국 매수 주문 [모의투자] VTTT1004U
    elif excg_cd == "SHEK":
        tr_id = "VTTS1003U"  # 홍콩 매수 주문 [모의투자] VTTS1003U
    elif excg_cd == "SHAA":
        tr_id = "VTTS0302U"  # 중국상해 매수 주문 [모의투자] VTTS0302U
    elif excg_cd == "SZAA":
        tr_id = "VTTS0306U"  # 중국심천 매수 주문 [모의투자] VTTS0306U
    elif excg_cd == "TKSE":
        tr_id = "VTTS0309U"  # 일본 매수 주문 [모의투자] VTTS0309U
    elif excg_cd in ("HASE", "VNSE"):
        tr_id = "VTTS0312U"  # 베트남(하노이,호치민) 매수 주문 [모의투자] VTTS0312U
    else:
        print("해외거래소코드 확인요망!!!")
        return None
...
def get_overseas_order_allcncl(excg_cd="", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    tr_id = "VTTS3018R"   # 모의투자 VTTS3018R
...
def get_overseas_inquire_balance(excg_cd="", crcy_cd="", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    tr_id = "VTTS3012R"   # 모의투자 VTTS3012R
...
def get_overseas_inquire_ccnl(st_dt="", ed_dt="", ord_dv="00", ccld_dv="00", excg_cd="%", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    tr_id = "VTTS3035R"   # 모의투자 VTTS3035R
...
def get_overseas_inquire_present_balance(dv="03", dvsn="01", natn="000", mkt="00", inqr_dvsn="00", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    tr_id = "VTRP6504R"   # 모의투자 VTRP6504R
...
def get_overseas_inquire_psamount(dv="03", dvsn="01", natn="000", mkt="00", inqr_dvsn="00", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    tr_id = "VTTS3007R"   # 모의투자 VTTS3007R
...
def get_overseas_price_inquire_asking_price(div="", excd="", itm_no="", tr_cont="", FK100="", NK100="", dataframe=None):
    ...
    print(f"Requesting overseas price with params: {params}")
    ...
    if res.getResCode() != 200:
        print(f"Error: API returned status code {res.getResCode()}")
        print(f"Response: {res.getResponse().text}")
        return None

    print(f"API response: {res.getResponse().json()}")
